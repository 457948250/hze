...
public class HealthyPushAdapter extends RecyclerView.Adapter<HealthyPushAdapter.ViewHolder> {

    private List<item_Push> mHealthyPush;

    private Context context;

    public HealthyPushAdapter(Context context, List<item_Push> mHealthyPush){
        this.context = context;
        this.mHealthyPush = mHealthyPush;
    }
