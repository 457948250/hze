...
import static com.healthy.com.healing.util.BitmapUtil.bmEnd;
import static com.healthy.com.healing.util.BitmapUtil.bmStart;
...
public class MapUtil {
    ...
    public void animateMapStatus(List<LatLng> points) {
        ...
        msUpdate =  MapStatusUpdateFactory.zoomTo(mCurrentZoom);
        baiduMap.animateMapStatus(msUpdate);
    }
